...
namespace OOD2_interface
{
    class ANDGate : GATE
    {
        ...
        public ANDGate(int locX, int locY, bool input1, bool input2, bool output, bool input1Sel, bool input2Sel, bool outputSel)
            : base(locX, locY)
        {
            input1value = input1;
            input2value = input2;
        ...
        public ANDGate(int locX, int locY)
            : base(locX, locY)
        {
            //pre: true
            input1value = false;
        ...
        public override void draw(PaintEventArgs a)
        {
            ...
            a.Graphics.DrawString("AND", myFont, mystringBrush, locationX + 20, locationY + 20);
